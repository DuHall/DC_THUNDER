<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Index.aspx.vb" Inherits="DCThunderMain.Index" %>
...
<body id="page-top" class="index" style="margin-top: 0px; padding-top: 0px;">
    ...
    <header>
        <div class="container" style="width: 100%; padding: 0px; margin: 0px;">
            <div class="row">
                <div class="col-lg-12" style="background-image: url(img/fieldbg.jpg); background-repeat: no-repeat; height: 650px; width: 100%; margin: 0px; padding: 0px; background-color: black;">
                   
                    <div class="intro-text" style="margin-top: 200px;"">
                        <span class="name" style="font-size: 25px;"><i>"Never limit yourself, never be satisfied, and smile-it's free!"</i></span>
						<span style="margin-left:50%; font-size: 25px;">- Jennie Finch</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="success" id="about" style="background-color: #0762b0">
        <div class="container" style="background-color: #0762b0" >
            ...
            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                <a class="thumbnail" href="#">
                    <img class="img-responsive" src="img/team/Brooke.png" alt="" style="position: relative; width: 100%; /* for IE 6 */">
                    <span class="thumbText">Brooke T.<br />Class of 2024</span>
                </a>
            </div>
            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                <a class="thumbnail" href="#">
    ...
    <section id="contact">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <center><h3>April 22 2017 beginning @ 10:30am - Mazzepa Park Field 2</h3></center>
                    <center><p style="font-size: 12px;">Click Address below on mobile device for easy directions</p></center>
                    <center><h4><a href="https://goo.gl/maps/AM3iFzyXz3D2">Mazzepa Park, 645 Mazzepa Rd Mooresvlle NC</a></h4></center>
                    <center><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3242.629364934536!2d-80.79700278433643!3d35.636862580204735!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8853fe119864e273%3A0xef289faab219b973!2sMazeppa+Park!5e0!3m2!1sen!2sus!4v1492714337885" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe></center>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="footer-col col-md-4" style="background-color: #0762b0">
                        ...
                        <p style="font-size: 20px;">Manager - Lin Hayworth</p>
                        <p style="font-size: 20px;">Bench Coach - Alan Grainger</p>
                        <p style="font-size: 20px;">Asst Coach - Mark Hughes</p>
                    </div>
                </div>
            </div>
        </div>
